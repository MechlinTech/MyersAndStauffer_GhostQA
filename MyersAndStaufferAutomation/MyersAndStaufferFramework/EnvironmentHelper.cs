...
namespace MyersAndStaufferFramework
{
    public class EnvironmentHelper : IEnvironmentHelper
    {
        ...
        {
            bool result;
            if (bool.TryParse(GetSetting(setting), out result))
            {
                return result;
            }
            else
        ...
        {
            // Load ConnectionStrings from config
            config = config ?? EnvironmentHelperUtils.GetCurrentConfiguration();
    ...
    public static class EnvironmentHelperUtils
    {
        ...
        public static IConfiguration GetCurrentConfiguration(string configName = "", bool useCache = true)
        {
            Func<IConfiguration> buildConfig = () =>
            {
                ...
                if (configName != null && File.Exists($"{Directory.GetCurrentDirectory()}/appsettings.{configName}.json"))
                {
